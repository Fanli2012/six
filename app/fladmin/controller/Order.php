...
class Order extends Base
{
    ...
    public function index()
    {
        ...
        if (!empty($_REQUEST['keyword']) && $_REQUEST['keyword'] != '') {
            $where[] = array('name|mobile|order_sn', 'like', '%' . $_REQUEST['keyword'] . '%');
        }
        if (isset($_REQUEST['mobile']) && $_REQUEST['mobile'] != '') {
            $where[] = array('mobile', 'like', '%' . $_REQUEST['mobile'] . '%');
        }

        if (isset($_REQUEST['order_sn']) && $_REQUEST['order_sn'] != '') {
            $where[] = array('order_sn', 'like', '%' . $_REQUEST['order_sn'] . '%');
        }

        if (isset($_REQUEST['name']) && $_REQUEST['name'] != '') {
            $where[] = array('name', 'like', '%' . $_REQUEST['name'] . '%');
        }
