...
class Index extends Common
{
    ...
    // 安卓升级信息
    public function andriod_upgrade()
    {
        $res = array(
            'app_name' => sysconfig('CMS_WEBNAME'), //app名字
            'apk_version' => 2.0, //版本号
            'is_force' => 0, //是否强制更新，0不强制，1强制
            'apk_url' => 'http://www.baidu.com/wap/app-release.apk', //apk下载地址
            'apk_des' => '描述：3.0.0' //版本更新的描述
        );
    ...
    public function erweima()
    {
        ...
        include(root_path() . 'extend/phpqrcode/phpqrcode.php'); //引入phpqrcode类
    ...
    {
        //导入类库
        include(root_path() . 'extend/hprose/HproseHttpClient.php'); //引入Hprose类
