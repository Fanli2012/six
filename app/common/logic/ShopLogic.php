...
class ShopLogic extends BaseLogic
{
    ...
    {
        return validate(ShopValidate::class);
    }
    ...
    public function getOne($where = array(), $field = '*')
    {
        ...
        $this->getModel()->setIncrement($where, 'click', 1);
    ...
    public function changePassword($data, $where = array())
    {
		...
		try {
            $this->getValidate()->scene('change_password')->check($data);
        } catch (ValidateException $e) {
            // 验证失败 输出错误信息
            return ReturnData::create(ReturnData::PARAMS_ERROR, null, $e->getError());
        }
    ...
    public function setting($data, $where = array())
    {
		...
		try {
            $this->getValidate()->scene('setting')->check($data);
        } catch (ValidateException $e) {
            // 验证失败 输出错误信息
            return ReturnData::create(ReturnData::PARAMS_ERROR, null, $e->getError());
        }
    ...
    public function reg($data)
    {
		...
		try {
            $this->getValidate()->scene('mobile_reg')->check($data);
        } catch (ValidateException $e) {
            // 验证失败 输出错误信息
            return ReturnData::create(ReturnData::PARAMS_ERROR, null, $e->getError());
        }
    ...
    public function resetpwd($data)
    {
		...
		try {
            $this->getValidate()->scene('resetpwd')->check($data);
        } catch (ValidateException $e) {
            // 验证失败 输出错误信息
            return ReturnData::create(ReturnData::PARAMS_ERROR, null, $e->getError());
        }
