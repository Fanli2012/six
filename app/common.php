...
{
    require_once root_path() . 'extend/phpAnalysis/phpAnalysis.php';
...
{
    require_once root_path() . 'extend/phpqrcode/qrlib.php';
    ob_start();
...
function sysconfig($varname = '')
{
    ...
    if (empty($sysconfig)) {
        ...
        $sysconfig = \think\facade\Db::name('sysconfig')->field('varname,value')->select();
